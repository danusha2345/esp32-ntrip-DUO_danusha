...
#define STATUS_LED_RED_GPIO GPIO_NUM_8
#define STATUS_LED_GREEN_GPIO GPIO_NUM_9
#define STATUS_LED_BLUE_GPIO GPIO_NUM_10
...
#elif defined(CONFIG_IDF_TARGET_ESP32C3)
#define STATUS_LED_RSSI_GPIO GPIO_NUM_2
#define STATUS_LED_SLEEP_GPIO GPIO_NUM_3
#define STATUS_LED_ASSOC_GPIO GPIO_NUM_4
#elif defined(CONFIG_IDF_TARGET_ESP32S3)
#define STATUS_LED_RSSI_GPIO GPIO_NUM_18
